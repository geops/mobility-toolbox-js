...
describe("MapsetKmlFormat", () => {
  let KML: MapsetKmlFormat;
  beforeEach(() => {
    KML = new MapsetKmlFormat();
  });
  ...
  describe("readFeatures() and writeFeatures()", () => {
          ...
          <Document>
            ...
            <Placemark>
                ...
                <ExtendedData>
                  ...
                  <Data name="lineEndIcon"><value>{"scale":0.35,"size":[36,58],"url":"fooarrowend.png","zIndex":14}</value></Data>
                  <Data name="lineJoin"><value>square</value></Data>
                  <Data name="lineStartIcon"><value>{"scale":0.35,"size":[36,58],"url":"fooarrowstart.png","zIndex":14}</value></Data>
                  <Data name="miterLimit"><value>14</value></Data>
                  <Data name="zIndex"><value>14</value></Data>
                </ExtendedData>
          ...
          <Document>
            ...
            <Placemark>
              ...
              <ExtendedData>
                ...
                <Data name="textFont">
                  <value>normal 16px arial, Arial, sans-serif</value>
                </Data>
    ...
    test("should add zIndex and rotation to icon style and pictureOptions to feature properties.", () => {
      ...
      expectWriteResult(feats, str, { resolution: 2 });
    });
